      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="w-full">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
          <div className="lg:col-span-2 flex flex-col gap-8">
            <Card>
              <CardHeader>
                <CardTitle className="font-headline">Context-Aware Generation (CAG)</CardTitle>
                <CardDescription>Tailor the AI's personality and expertise.</CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="font-headline">Knowledge-Augmented Generation (KAG)</CardTitle>
                <CardDescription>Inject a specific fact for the AI to use.</CardDescription>
              </CardHeader>
              <CardContent>
                <FormField
                  control={form.control}
          ...
          <div className="lg:col-span-3 flex flex-col gap-8">
            <Card>
              <CardHeader>
                <CardTitle className="font-headline">Retrieval-Augmented Generation (RAG)</CardTitle>
                <CardDescription>Provide document context by uploading a text file or pasting content.</CardDescription>
              </CardHeader>
              <CardContent>
                <FormField
                    control={form.control}
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Ask the AI anything based on the context you've provided.</CardDescription>
                </CardHeader>
                <CardContent>
                    <FormField
                    control={form.control}
                    ...
                    render={({ field }) => (
                        ...
                        <FormControl>
                            <Textarea
                            placeholder="e.g., Can you explain what Transformers are?"
                    ...
                    />
                    <Button type="submit" disabled={isLoading} className="mt-4 w-full font-headline text-lg py-6">
                        {isLoading ? (
                            <>
